...
contract Ownable {
    ...
    modifier onlyOwner
    {
        require(msg.sender == _ownwer, "Owner of this contract is required");
        _;
    }
    ...
    onlyOwner 
    {
        // [x] TODO add functionality to transfer control of the contract to a newOwner.
        // [x] make sure the new owner is a real address
...
//  TODO's: 
//  [x] Create a Pausable contract that inherits from the Ownable contract
...
contract ERC721 is Pausable, ERC165 {
    ...
    public 
    {
        ...
        // [x] TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true

        require((getOwner() == msg.sender) || isApprovedForAll(msg.sender, to), "Caller is not authorized");
    ...
    returns (address) 
    {
        // [x]TODO return token approval if it _exists
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        requite(!exists(tokenId), "Token already exists");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    // [x] TODO: create external getter functions for name, symbol, and _baseTokenURI
...
//  TODO's: [x] Create CustomERC721Token contract that inherits from the ERC721Metadata contract. You can name this contract as you please
...
contract IRealEstateToken is ERC721Metadata {
    ...
    returns (bool)
    {
        ...
        //  [x] can only be executed by the contract Owner    
